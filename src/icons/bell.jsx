const Bell = props => (
    <svg width="16" height="20" viewBox="0 0 16 20" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M10.1908 17.9714C8.9634 19.3347 7.0487 19.3509 5.80957 17.9714" stroke="currentColor" />
    </svg>
)
